...
#[no_mangle]
pub unsafe extern "C" fn rs_dns_tx_set_detect_flags(tx: *mut std::os::raw::c_void,
                                             dir: u8,
                                             flags: u64)
{
...
#[no_mangle]
pub unsafe extern "C" fn rs_dns_tx_get_detect_flags(tx: *mut std::os::raw::c_void,
                                             dir: u8)
                                       -> u64
{
    let tx = cast_pointer!(tx, DNSTransaction);
...
#[no_mangle]
pub unsafe extern "C" fn rs_dns_tx_set_logged(_state: *mut std::os::raw::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn rs_dns_tx_get_logged(_state: *mut std::os::raw::c_void,
                                       tx: *mut std::os::raw::c_void)
                                       -> u32
{
    let tx = cast_pointer!(tx, DNSTransaction);
