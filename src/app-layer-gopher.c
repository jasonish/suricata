...
/*
 * TODO: Update \author in this file and app-layer-gopherrust.h.
 ...
 * gopherrust pruposes.
 *
 * This gopherrust implements a simple application layer for something
...
#ifdef HAVE_RUST
#include "rust-applayergopher-gopher-gen.h"
#endif

void RegisterGopherParsers(void)
{
#ifdef HAVE_RUST
    SCLogNotice("Registring Rust gopher parser.");
    rs_gopher_register_parser();
#endif
#ifdef UNITTESTS
