...
int DetectBase64DataDoMatch(
        DetectEngineCtx *de_ctx, DetectEngineThreadCtx *det_ctx, const Signature *s, Flow *f)
{
...
static int DetectBase64DataSetupTest01(void)
{
    ...
    de_ctx->sig_list =
            SigInit(de_ctx, "alert smtp any any -> any any (msg:\"DetectBase64DataSetupTest\"; "
