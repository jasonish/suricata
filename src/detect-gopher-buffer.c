...
void DetectGopherBufferRegister(void)
{
    ...
    DetectAppLayerInspectEngineRegister2("gopher_buffer",
    ...
    DetectAppLayerMpmRegister2("gopher_buffer", SIG_FLAG_TOSERVER, 0,
            PrefilterGenericMpmRegister, GetData,
            ALPROTO_GOPHER, 0);
    DetectAppLayerMpmRegister2("gopher_buffer", SIG_FLAG_TOCLIENT, 0,
            PrefilterGenericMpmRegister, GetData,
            ALPROTO_GOPHER, 0);
...
#ifdef UNITTESTS
#include "tests/detect-gopher-buffer.c"
#endif
