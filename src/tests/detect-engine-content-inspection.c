...
static int DetectEngineContentInspectionTest03(void)
{
    ...
    TEST_RUN("ababc", 5, "content:\"a\"; content:\"b\"; distance:0; content:\"c\"; distance:0;",
            true, 3);
    TEST_RUN("ababc", 5, "content:\"a\"; content:\"b\"; distance:0; content:\"d\"; distance:0;",
            false, 3);

    TEST_RUN("ababc", 5,
            "content:\"a\"; content:\"b\"; distance:0; within:1; content:\"d\"; distance:0; "
            "within:1;",
            false, 5);
    ...
    // 5 steps: (1) a, (2) 1st b, (3) c not found, (4) 2nd b, (5) c found
    TEST_RUN("ababc", 5, "content:\"a\"; content:\"b\"; distance:0; within:1; pcre:\"/^c$/R\";",
            true, 5);
    // 6 steps: (1) a, (2) 1st b, (3) c not found, (4) 2nd b, (5) c found, (6) bab
    TEST_RUN("ababc", 5,
...
static int DetectEngineContentInspectionTest05(void)
{
    ...
    TEST_RUN("ababc", 5,
            "content:\"a\"; content:\"b\"; distance:0; within:1; content:\"b\"; content:\"c\"; "
            "distance:0; within:1;",
            true, 5);
...
static int DetectEngineContentInspectionTest06(void)
{
    ...
    TEST_RUN("abcXYZ", 6,
            "content:\"abc\"; content:\"XYZ\"; distance:0; within:3; isdataat:!1,relative;", true,
            2);
    ...
    TEST_RUN("xxxxxxxxxxxxxxxxxyYYYYYYYYYYYYYYYY", 34,
            "content:\"yYYYYYYYYYYYYYYYY\"; distance:9; within:29; isdataat:!1,relative;", true, 1);
    TEST_FOOTER;
}
...
{
    TEST_HEADER;
    TEST_RUN("abcabcabcabcabcabcabcabcabcabcd", 31,
            "content:\"a\"; content:\"b\"; within:1; distance:0; content:\"c\"; distance:0; "
            "within:1; content:\"d\";",
            true, 4);
    TEST_RUN("abcabcabcabcabcabcabcabcabcabcd", 31,
            "content:\"a\"; content:\"b\"; within:1; distance:0; content:\"c\"; distance:0; "
            "within:1; content:\"d\"; within:1; distance:0; ",
            true, 31);
    TEST_RUN("abcabcabcabcabcabcabcabcabcabcx", 31,
            "content:\"a\"; content:\"b\"; within:1; distance:0; content:\"c\"; distance:0; "
            "within:1; content:\"d\"; within:1; distance:0; ",
            false, 31);

    TEST_RUN("abcabcabcabcabcabcabcabcabcabcx", 31,
            "content:\"a\"; content:\"b\"; distance:0; content:\"c\"; distance:0; content:\"d\"; "
            "distance:0; ",
            false, 4);
    TEST_RUN("abcabcabcabcabcabcabcabcabcabcx", 31,
    ...
    TEST_RUN("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdx", 41,
            "content:\"a\"; content:\"b\"; distance:0; content:\"c\"; distance:0; content:\"d\"; "
            "distance:0; content:\"e\"; distance:0; ",
            false, 5);
    TEST_RUN("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdx", 41,
            "content:\"a\"; content:\"b\"; distance:0; content:\"c\"; distance:0; content:\"d\"; "
            "distance:0; pcre:\"/^e/R\"; ",
            false, 14); // TODO should be 5?
    TEST_RUN("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdx", 41,
            "content:\"a\"; content:\"b\"; distance:0; content:\"c\"; distance:0; content:\"d\"; "
            "distance:0; isdataat:!1,relative; ",
            false, 4);
...
static int DetectEngineContentInspectionTest09(void)
{
    ...
    TEST_RUN("abc03abcxyz", 11,
            "content:\"abc\"; byte_jump:2,0,relative,string,dec; content:\"xyz\"; within:3;", true,
            3);
    TEST_RUN("abc03abc03abcxyz", 16,
            "content:\"abc\"; byte_jump:2,0,relative,string,dec; content:\"xyz\"; within:3;", true,
            5);
    TEST_RUN("abc03abc03abcxyz", 16,
    ...
    TEST_RUN("abc03abc03abcxyz", 16,
            ...
            "pcre:\"/klm$/R\";",
            false, 7);
    TEST_RUN("abc03abc03abcxyzklm", 19,
            "content:\"abc\"; byte_jump:2,0,relative,string,dec; content:\"xyz\"; within:3; "
            "pcre:\"/klm$/R\";",
            true, 6);
    TEST_RUN("abc03abc03abcxyzklx", 19,
            "content:\"abc\"; byte_jump:2,0,relative,string,dec; content:\"xyz\"; within:3; "
            "pcre:\"/^klm$/R\";",
            false, 7);
    TEST_RUN("abc03abc03abc03abcxyzklm", 24,
            "content:\"abc\"; byte_jump:2,0,relative,string,dec; content:\"xyz\"; within:3; "
            "pcre:\"/^klm$/R\";",
            true, 8);
...
static int DetectEngineContentInspectionTest10(void)
{
    ...
    TEST_RUN("x9x9abcdefghi", 13,
            "content:\"x\"; byte_extract:1,0,data_size,string,relative; "
            "isdataat:data_size,relative;",
            true, 3);
    TEST_RUN("x9x9abcdefgh", 12,
            "content:\"x\"; byte_extract:1,0,data_size,string,relative; "
            "isdataat:!data_size,relative;",
            true, 5);
    TEST_RUN("x9x9abcdefgh", 12,
            "content:\"x\"; depth:1; byte_extract:1,0,data_size,string,relative; "
            "isdataat:!data_size,relative;",
            false, 3);
    /* check for super high extracted values */
    TEST_RUN("100000000abcdefghi", 18, "byte_extract:0,0,data_size,string; isdataat:data_size;",
            false, 2);
    TEST_RUN("100000000abcdefghi", 18, "byte_extract:0,0,data_size,string; isdataat:!data_size;",
            true, 2);
    TEST_FOOTER;
...
static int DetectEngineContentInspectionTest12(void)
{
    ...
    TEST_RUN("abcXYZ", 6, "content:\"abc\"; content:\"XYZ\"; distance:0; within:3; endswith;", true,
            2);
    ...
    TEST_RUN("xxxxxxxxxxxxxxxxxyYYYYYYYYYYYYYYYY", 34,
            "content:\"yYYYYYYYYYYYYYYYY\"; distance:9; within:29; endswith;", true, 1);
    TEST_FOOTER;
}
...
static int DetectEngineContentInspectionTest13(void)
{
    ...
    TEST_RUN("ab", 2, "content:\"a\"; startswith; content:\"b\"; within:1; distance:0; endswith;",
            true, 2);
...
{
    UtRegisterTest("DetectEngineContentInspectionTest01", DetectEngineContentInspectionTest01);
    UtRegisterTest("DetectEngineContentInspectionTest02", DetectEngineContentInspectionTest02);
    UtRegisterTest("DetectEngineContentInspectionTest03", DetectEngineContentInspectionTest03);
    UtRegisterTest("DetectEngineContentInspectionTest04", DetectEngineContentInspectionTest04);
    UtRegisterTest("DetectEngineContentInspectionTest05", DetectEngineContentInspectionTest05);
    UtRegisterTest("DetectEngineContentInspectionTest06", DetectEngineContentInspectionTest06);
    UtRegisterTest("DetectEngineContentInspectionTest07", DetectEngineContentInspectionTest07);
    UtRegisterTest("DetectEngineContentInspectionTest08", DetectEngineContentInspectionTest08);
    UtRegisterTest("DetectEngineContentInspectionTest09", DetectEngineContentInspectionTest09);
    UtRegisterTest("DetectEngineContentInspectionTest10", DetectEngineContentInspectionTest10);
    UtRegisterTest(
            "DetectEngineContentInspectionTest11 startswith", DetectEngineContentInspectionTest11);
    UtRegisterTest(
            "DetectEngineContentInspectionTest12 endswith", DetectEngineContentInspectionTest12);
