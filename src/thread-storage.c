...
static int ThreadStorageTest01(void)
{
    ...
    SCThreadStorageId id1 = SCThreadStorageRegister("test", 8, StorageTestAlloc, StorageTestFree);
    FAIL_IF(id1.id < 0);

    SCThreadStorageId id2 =
            SCThreadStorageRegister("variable", 24, StorageTestAlloc, StorageTestFree);
    FAIL_IF(id2.id < 0);

    SCThreadStorageId id3 =
            SCThreadStorageRegister("store", sizeof(void *), StorageTestAlloc, StorageTestFree);
    FAIL_IF(id3.id < 0);
    ...
    void *ptr1a = SCThreadAllocStorageById(tv, id1);
    FAIL_IF_NULL(ptr1a);

    void *ptr2a = SCThreadAllocStorageById(tv, id2);
    FAIL_IF_NULL(ptr2a);

    void *ptr3a = SCThreadAllocStorageById(tv, id3);
    FAIL_IF_NULL(ptr3a);
...
static int ThreadStorageTest02(void)
{
    ...
    SCThreadStorageId id1 = SCThreadStorageRegister("test", sizeof(void *), NULL, StorageTestFree);
    FAIL_IF(id1.id < 0);
...
static int ThreadStorageTest03(void)
{
    ...
    SCThreadStorageId id1 = SCThreadStorageRegister("test1", sizeof(void *), NULL, StorageTestFree);
    FAIL_IF(id1.id < 0);

    SCThreadStorageId id2 = SCThreadStorageRegister("test2", sizeof(void *), NULL, StorageTestFree);
    FAIL_IF(id2.id < 0);

    SCThreadStorageId id3 = SCThreadStorageRegister("test3", 32, StorageTestAlloc, StorageTestFree);
    FAIL_IF(id3.id < 0);
