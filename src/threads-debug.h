...
#define SCMutexLock_dbg(mut)                                                                       \
    ({                                                                                             \
        printf("%16s(%s:%d): (thread:%" PRIuMAX ") locking mutex %p\n", __FUNCTION__, __FILE__,    \
                __LINE__, (uintmax_t)pthread_self(), mut);                                         \
    ...
    ({                                                                                             \
        ...
        if (ret != 0) {                                                                            \
            switch (ret) {                                                                         \
                case EINVAL:                                                                       \
                    printf("The value specified by attr is invalid\n");                            \
                    printf("%16s(%s:%d): (thread:%" PRIuMAX                                        \
                           ") mutex %p initialization returned %" PRId32 "\n",                     \
                            __FUNCTION__, __FILE__, __LINE__, (uintmax_t)pthread_self(), mut,      \
                            ret);                                                                  \
                    break;                                                                         \
                case EAGAIN:                                                                       \
                    printf("The system temporarily lacks the resources to create another "         \
                           "mutex\n");                                                             \
                    printf("%16s(%s:%d): (thread:%" PRIuMAX                                        \
                           ") mutex %p initialization returned %" PRId32 "\n",                     \
                            __FUNCTION__, __FILE__, __LINE__, (uintmax_t)pthread_self(), mut,      \
...
#define SCCondWait_dbg(cond, mut)                                                                  \
    ({                                                                                             \
        ...
        switch (ret) {                                                                             \
            case EINVAL:                                                                           \
                printf("The value specified by attr is invalid (or a SCCondT not "                 \
                       "initialized!)\n");                                                         \
...
#define SCSpinLock_dbg(spin)                                                                       \
    ({                                                                                             \
        printf("%16s(%s:%d): (thread:%" PRIuMAX ") locking spin %p\n", __FUNCTION__, __FILE__,     \
                __LINE__, (uintmax_t)pthread_self(), spin);                                        \
...
#define SCSpinDestroy_dbg(spin)                                                                    \
    ({                                                                                             \
        printf("%16s(%s:%d): (thread:%" PRIuMAX ") condition %p waiting\n", __FUNCTION__,          \
                __FILE__, __LINE__, (uintmax_t)pthread_self(), spin);                              \
...
#define SCRWLockRDLock_dbg(rwl)                                                                    \
    ({                                                                                             \
        printf("%16s(%s:%d): (thread:%" PRIuMAX ") locking rwlock %p\n", __FUNCTION__, __FILE__,   \
                __LINE__, (uintmax_t)pthread_self(), rwl);                                         \
...
#define SCRWLockTryWRLock_dbg(rwl)                                                                 \
    ({                                                                                             \
        printf("%16s(%s:%d): (thread:%" PRIuMAX ") trylocking rwlock %p\n", __FUNCTION__,          \
                __FILE__, __LINE__, (uintmax_t)pthread_self(), rwl);                               \
        ...
        if (ret != 0) {                                                                            \
            switch (ret) {                                                                         \
                case EINVAL:                                                                       \
                    printf("The value specified by attr is invalid\n");                            \
                    printf("%16s(%s:%d): (thread:%" PRIuMAX                                        \
                           ") rwlock %p initialization returned %" PRId32 "\n",                    \
                ...
                case EAGAIN:                                                                       \
                    ...
                    break;                                                                         \
                case ENOMEM:                                                                       \
                    printf("The process cannot allocate enough memory to create another "          \
                           "rwlock\n");                                                            \
                    printf("%16s(%s:%d): (thread:%" PRIuMAX                                        \
                           ") rwlock %p initialization returned %" PRId32 "\n",                    \
                            __FUNCTION__, __FILE__, __LINE__, (uintmax_t)pthread_self(), rwl,      \
