...
#if (!defined SCMutex || !defined SCMutexAttr || !defined SCMutexInit || !defined SCMutexLock ||   \
        !defined SCMutexTrylock || !defined SCMutexUnlock || !defined SCMutexDestroy ||            \
...
#error "Mutex types and/or macro's not properly defined"
        ...
        !defined SCCtrlMutexLock || !defined SCCtrlMutexTrylock || !defined SCCtrlMutexUnlock ||   \
...
#error "Spinlock types and/or macro's not properly defined"
        ...
        !defined SCRWLockRDLock || !defined SCRWLockTryWRLock || !defined SCRWLockTryRDLock ||     \
        !defined SCRWLockUnlock || !defined SCRWLockDestroy)
#error "SCRWLock types and/or macro's not properly defined"
#endif

#if (!defined SCCondT || !defined SCCondInit || !defined SCCondSignal || !defined SCCondDestroy || \
        !defined SCCondWait)
